...
function exactSampledAction(frame) {
    return frame.active.length === 1 && frame.active[0] === frame.expected;
}
...
const checks = [
    ['visible frames execute exactly the sampled action', visible.emulator.frames.every(exactSampledAction)],
    ['hidden 80-round batch executes exactly the sampled action', hiddenBatch.emulator.frames.every(exactSampledAction)],
